...
CSystemTray::CSystemTray() { Initialise(); }

CSystemTray::CSystemTray(CWnd *pParent, UINT uCallbackMessage,
...
BOOL CSystemTray::Create(CWnd *pParent, UINT uCallbackMessage,
                         LPCTSTR szToolTip, HICON icon, UINT uID) {
  ...
  CWnd::CreateEx(0, AfxRegisterWndClass(0), _T(""), WS_POPUP, 0, 0, 10, 10,
                 NULL, 0);
...
HICON CSystemTray::GetIcon() const { return (m_bEnabled) ? m_tnd.hIcon : NULL; }
