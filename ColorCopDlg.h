...
protected:
  ...
  bool CColorCopDlg::AveragePixelArea(HDC hdc, int *m_Reddec, int *m_Greendec,
                                      int *m_Bluedec, CPoint point);
  ...
  afx_msg void
  OnUpdatePopupApplicationMinimizetosystemtrayonstart(CCmdUI *pCmdUI);
